...
@section('konten')
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Konfirmasi</h5>
                ...
                <form action="{{ route('pembayaran.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3"><label for="namaperusahaanlabel">Pengajuan Sebesar <b>({{rupiah($totaltagihan)}})</b></label>
                            <ul class="list-group">
                            @foreach ($keranjang as $k)
                        ...
                        <div class="mb-3 row">
                            <label for="nomerlabel" class="col-sm-4 col-form-label">Bukti TTD Dosen/Atasan</label>
                            <div class="col-sm-8">
                        ...
                        <div class="mb-3 row">
                            <label for="nomerlabel" class="col-sm-4 col-form-label">Tanggal</label>
                            <div class="col-sm-8">
                        ...
                        <a class="col-sm-1 btn btn-dark  btn-sm" href="{{ url('/pembayaran/viewkeranjang') }}" role="button">Cancel</a>
