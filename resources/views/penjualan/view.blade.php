            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <h5 class="card-title fw-semibold">Pengajuan Dana</h5>
                    ...
                    <a href="{{url('penjualan/keranjang')}}" class="btn btn-success btn-icon-split">
                            ...
                            <span class="text">Submit Pengajuan</span>
                    </a>
                </div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" id="tipeproses" name="tipeproses" value="">
                ...
                <div class="mb-3 row">
                    <label for="nomerlabel" class="col-sm-4 col-form-label">Nama</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_barang" name="nama_barang" readonly>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="lantailabel" class="col-sm-4 col-form-label">Total Pengajuan</label>
                    <div class="col-sm-8">
