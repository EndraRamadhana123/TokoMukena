...
<div class="body-wrapper">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <h5 class="card-title fw-semibold mb-4">Contoh Mitra Kegiatan Form</h5>
                  <div class="card">

                        <!-- Card Header - Dropdown -->
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Mitra Kegiatan Form</h6>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="namadokumenlama" name="namadokumenlama" value="">
                    <div class="mb-3 row">
                        <label for="nomerlabel" class="col-sm-4 col-form-label">Nama Mitra</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="nama_mitra" name="nama_mitra" placeholder="Masukkan Nama Mitra">
                            <div class="invalid-feedback errornama_mitra"></div>
                        </div> 
                    </div>
    ...
    <script>
          $(function(){
                $('.tampilmodaltambah').on('click', function(){
                  ...
                  $('#labelmodalubah').html('Tambah Data Mitra Kegiatan');
    ...
    <script>
            function datacontohform(){
                $.ajax({
                    url: '{{ url('mitra_kegiatan/fetchAll') }}',
                    method: 'get',
                    success: function(response) {
